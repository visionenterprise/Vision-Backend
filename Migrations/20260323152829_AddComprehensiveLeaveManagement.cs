...
{
    /// <inheritdoc />
    public partial class AddComprehensiveLeaveManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                SET
                    ""LeaveYear"" = EXTRACT(YEAR FROM ""StartDate"")::integer,
                    ""RequestedDays"" = GREATEST((""EndDate"" - ""StartDate"") + 1, 1),
                    ""HolidayOverlapDays"" = 0,
                    ""DeductedDays"" = GREATEST((""EndDate"" - ""StartDate"") + 1, 1)
            ");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualQuotaDaysOverride = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
